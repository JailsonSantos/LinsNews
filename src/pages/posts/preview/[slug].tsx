...
// para usar emojin aperte windows + .
...
// Essa função é usada somente em paginas dinamicas ex: [slug].tsx,
// Pois da pra definir no momento do build, quais paginas devem ser estaticas,
